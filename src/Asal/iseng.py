...
class spam:
	...
	def tokped(self):
		...
		regist = requests.get('https://accounts.google.com/o/oauth2/iframe#origin=https%3A%2F%2Fwww.tokopedia.com&rpcToken=806366230.2616894'+self.nomer+'&ld=https%3A%2F%2Faccounts.tokopedia.com%2Fregister%3Ftype%3Dphone%26phone%3D{}%26status%3DeyJrIjp0cnVlLCJtIjp0cnVlLCJzIjpmYWxzZSwiYm90IjpmYWxzZSwiZ2MiOmZhbHNlfQ%253D%253D', headers = kirim).text
